...
class ".ucfirst($plural)." extends CI_Controller{
		...
		public function __construct(){
			...
			public function form_new(){
				...
				$"."data['title'] = 'Nuevo ".ucfirst($singular)."';
...
$controller .="     
					...
					$"."this->session->set_flashdata('success', '".ucfirst(str_replace('_',' ',$field))." creada. <a href=\"$plural/detail/'.$"."this->db->insert_id().'\">Ver</a>');
			...
			public function editar(){
				$"."this->load->helper('form');
				$"."data['title']= 'Editar ".ucfirst($singular)."';	
...
$controller .="	);
				...
				if($"."this->input->post('id')!=\"\"){
					redirect('control/$plural/detail/'.$"."this->input->post('id'), 'refresh');
				}else{
					redirect('control/$plural', 'refresh');
				}
...
$filecon = fopen("proyectos/$proyecto/controllers/control/$plural".".php", "w+");
...
class ".ucfirst($plural)." extends CI_Controller{
		...
		public function __construct(){
			...
			public function index(){
				...
				$"."data['title'] = 'All';
				$"."data['menu'] = '$plural/menu_$singular';
				$"."data['content'] = '$plural/all';
				$"."data['query'] = $"."this->$singular"."->get_records('$plural');
			...
			public function detail(){
				...
				$"."data['title'] = 'details $singular';
				$"."data['content'] = '$plural/detail';
				$"."data['menu'] = '$plural/menu_$singular';
				$"."data['query'] = $"."this->$singular->"."get_record($"."this->uri->segment(4));
				$"."this->load->view('layout', $"."data);
			}
...
$filecon_f = fopen("proyectos/$proyecto/controllers/$plural".".php", "w+");
